	...
	*/
	...
	function deleteJDLRow(inputIds, inputNames, grid, ansyToDatagrid, ansyToInput) {
		...
		if(undefined != ansyToInput && "" != ansyToInput.trim()) {
			var new_ids = [] ;
			var new_names = [] ;
			var allRows = developsDetail.datagrid("getRows");
			if(allRows.length > 0) {
	...
	function back() {
		...
		//	if(c) {
				centerPanel.panel("refresh", $.webapp.contextPath + "/admin/oa/project/project_detail_view.do") ;
		//	}
		//});
	}
</script>
					...
					<div class="form_container">
						<table class="tableform">
							...
							<tr>
								<th>项目审批人：</th>
								<td colspan="3">
									<input name="proj_approve_person_names" readonly="readonly" class="easyui-validatebox" style="width:660px;" type="text" />
			    	...
			    	<div class="form_container">
				    	<table class="tableform">
							<tr>
								...
								<td colspan="2">
									<input name="proj_creator_name" class="easyui-validatebox i300" type="text" readonly="readonly" />
									<input name="proj_creator_id" type="hidden" />
								</td>
							</tr>
							<tr>
								<th>项目负责人：</th>
								<td colspan="2">
									<input name="proj_owner_name" class="easyui-validatebox i300" type="text" readonly="readonly" />
							...
							<tr>
								<th>项目经理：</th>
								<td colspan="2">
									<input name="proj_manager_name" class="easyui-validatebox i300" type="text" readonly="readonly" />
									<input name="proj_manager_id" type="hidden" />
									<a onClick="personDblgridFunc('proj_owner_id', 'proj_owner_name');" class="easyui-linkbutton" data-options="plain: true, iconCls: 'ext_add'">添加</a>
									<a onClick="personDblgridClearFunc('proj_owner_id', 'proj_owner_name');" class="easyui-linkbutton" data-options="plain: true, iconCls: 'icon-metro-redo2'">清空</a>
								</td>
							</tr>
							...
							<tr>
								...
								<td style="border-left:0px;">
									<a onClick="personDblgridFunc('proj_develop_engine_ids', 'proj_develop_engine_names','','developsDetail');" class="easyui-linkbutton" data-options="plain: true, iconCls: 'ext_add'">添加</a>
									<a onClick="personDblgridClearFunc('proj_develop_engine_ids', 'proj_develop_engine_names','','developsDetail');" class="easyui-linkbutton" data-options="plain: true, iconCls: 'icon-metro-redo2'">清空</a>
								</td>
							</tr>
							<tr>
								<th>测试工程师：</th>
		            	...
		            	<div class="s_box">
		            		...
		            		<div class="gr">
			            		<div class="st">
				            		...
				            		<a style="float:left;" onClick="personDblgridFunc('proj_develop_engine_ids', '', 'developsDetail', '', 'proj_develop_engine_names');" class="easyui-linkbutton" data-options="plain: true, iconCls: 'ext_add'">添加数据</a>
									<a style="float:left;" onClick="deleteJDLRow('proj_develop_engine_ids', '', 'developsDetail', '', 'proj_develop_engine_names');" class="easyui-linkbutton" data-options="plain: true, iconCls: 'ext_remove'">删除</a>
			            		</div>
		            		</div>
		            	</div>
		            </div>
