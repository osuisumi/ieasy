package com.ieasy.basic.util.image.gm;
...
public class GMImageUtil {
	...
	private static Logger logger = LoggerFactory.getLogger(GMImageUtil.class);
	...
	public void compress(String srcPath, String newPath) {
		try {
			File file = new File(FilenameUtils.getFullPath(newPath)) ;
			if(!file.exists()) {
				file.mkdirs() ;
			}
	...
	public static void main(String[] args) {
		...
		GMImageUtil gm = new GMImageUtil() ;
