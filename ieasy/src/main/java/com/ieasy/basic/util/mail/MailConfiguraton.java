...
public class MailConfiguraton {
	...
	private MailConfiguraton() {
		...
		this.setMailAliasName((null == ConfigUtil.get("mail.aliasname") || "".equals(ConfigUtil.get("mail.aliasname"))?"":ConfigUtil.get("mail.aliasname"))) ;
		this.setMailFromAdmin(ConfigUtil.get("mail.from")) ;
		this.setUserNameAdmin((null == ConfigUtil.get("mail.username") || "".equals(ConfigUtil.get("mail.username"))?null:ConfigUtil.get("mail.username"))) ;
		this.setPassWordAdmin((null == ConfigUtil.get("mail.password") || "".equals(ConfigUtil.get("mail.password"))?null:ConfigUtil.get("mail.password"))) ;
	}
