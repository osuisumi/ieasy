...
public class GlobalForm extends PageHelper implements Serializable {
	...
	//OA服务设置
	private Integer mail_host ;								//邮件服务IP地址
	
	private Integer mail_port ;								//邮件服务端口
	
	private Integer mail_recv ;								//邮件收取间隔
	
	private Integer mail_pop_port ;							//POP3端口
	
	private Integer daemon_timer ;							//监控服务监控其他服务运行状态的间隔时间
	
	private Integer default_attach_path ;					//默认附件路径
